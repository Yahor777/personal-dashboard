...
- ✅ **Email валидация** при входе/регистрации
- 🔄 **Автоматические повторы** AI запросов
- 📋 **Копирование AI ответов** одним кликом

## 🆕 Что нового в v0.4.0

### ✅ Email валидация
- Проверка корректности email при входе и регистрации
- Понятные сообщения об ошибках

### ⏳ Индикаторы загрузки
- Визуальная обратная связь для всех операций
- "Вход...", "Регистрация...", "AI думает..."

### 🛡️ Улучшенная обработка ошибок AI
- Timeout 30 секунд
- До 2 повторных попыток с exponential backoff
- Детальные сообщения об ошибках

### 📝 Markdown рендеринг
- Форматированные ответы AI
